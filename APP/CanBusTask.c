...
//					 GMYawEncoder.ecd_angle = (float)(GMYawEncoder.raw_value)*360/8192;
//					 static int count=0;
//					 if(count>=200)
//					 {
//							char temp[50];
//							sprintf(temp,"yawangel:%10.3f  ",GMYawEncoder.ecd_angle);	
...
//					  GMPitchEncoder.ecd_angle = (float)(GMPitchEncoder.raw_value)*360/8192;
//					  static int count2=0;
//					  if(count2>=200)
//					  {
//							 char temp[50];
//							 sprintf(temp,"pitangle:%10.3f  ",GMPitchEncoder.ecd_angle);	
//							 UART3_PutStr (temp);//发送字符串
//							 count2=0;
//					  }		
//					  count2++;
